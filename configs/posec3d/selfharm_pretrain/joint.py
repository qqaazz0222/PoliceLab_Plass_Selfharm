model = dict(
    ...
    cls_head=dict(
        type='I3DHead', in_channels=512, num_classes=99, dropout=0.5),
    test_cfg=dict(average_clips='prob'))
dataset_type = 'PoseDataset'
ann_file = 'data/selfharm/selfharm_hrnet.pkl'
...
log_level = 'INFO'
work_dir = './work_dirs/posec3d/slowonly_r50_selfharm/joint'
