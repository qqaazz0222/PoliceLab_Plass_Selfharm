...
def main():
    ...
    # cv2.VideoWriter(args.out_filename, fourcc = fourcc, fps = 30, remove_temp=True)
    # # fps = 24.0
    # # vid = mpy.ImageSequenceClip([x[:, :, ::-1] for x in vis_frames], fps=fps)
    # # vid.write_videofile(args.out_filename, fps=fps, remove_temp=True)
